    ...
    private void loadNativeAds() {
        if (Constant.isNativeAd && arrayList.size() >= 10) {
            if (Constant.natveAdType.equals("admob")) {
                AdLoader.Builder builder = new AdLoader.Builder(SongByServerPlaylistActivity.this, Constant.nativeAdID);
                ...
                mNativeAdsManager = new NativeAdsManager(SongByServerPlaylistActivity.this, Constant.nativeAdID, 5);
