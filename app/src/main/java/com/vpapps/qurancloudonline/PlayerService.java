...
public class PlayerService extends IntentService implements Player.EventListener {
    ...
    public void onCreate() {
        ...
        dataSourceFactory = new DefaultDataSourceFactory(getApplicationContext(), Util.getUserAgent(getApplicationContext(), "qurancloudonline"), bandwidthMeter);
    ...
    private void updateNotiImage() {
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                try {
                    JsonUtils.okhttpPost(Constant.SERVER_URL, methods.getAPIRequest(Constant.METHOD_SINGLE_SONG,0, "", Constant.arrayList_play.get(Constant.playPos).getId(),"","","","","","","","","","","",Constant.itemUser.getId(),"", null));
