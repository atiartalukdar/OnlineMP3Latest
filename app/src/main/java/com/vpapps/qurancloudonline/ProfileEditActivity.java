...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setBackgroundTintList(editText_name, ColorStateList.valueOf(getResources().getColor(R.color.primary)));
        ViewCompat.setBackgroundTintList(editText_email, ColorStateList.valueOf(getResources().getColor(R.color.primary)));
        ViewCompat.setBackgroundTintList(editText_phone, ColorStateList.valueOf(getResources().getColor(R.color.primary)));
        ViewCompat.setBackgroundTintList(editText_pass, ColorStateList.valueOf(getResources().getColor(R.color.primary)));
        ViewCompat.setBackgroundTintList(editText_cpass, ColorStateList.valueOf(getResources().getColor(R.color.primary)));
        ...
        button_update.setBackground(methods.getRoundDrawable(getResources().getColor(R.color.primary)));
