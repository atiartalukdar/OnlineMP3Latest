    ...
    private void loadNativeAds() {
        if (Constant.isNativeAd && arrayList.size() >= 10) {
            if (Constant.natveAdType.equals("admob")) {
                AdLoader.Builder builder = new AdLoader.Builder(SongByCatActivity.this, Constant.nativeAdID);
                ...
                mNativeAdsManager = new NativeAdsManager(SongByCatActivity.this, Constant.nativeAdID, 5);
