...
public class BaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Dialog dialog_rate;
    Dialog dialog_rate_for_google_play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rateAppButton =  findViewById(R.id.btn_rate);
...
//            iv_music_shuffle.setColorFilter(Color.WHITE);
//            iv_music_repeat.setColorFilter(Color.WHITE);
...
//                Constant.isScrolled = true;
        ...
        if (Constant.pushSID.equals("0")) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_SINGLE_SONG, 0, deviceId, Constant.pushSID, "", "", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "", null)).execute();
        }
...
//                        methods.animatePhotoLike(view_round, imageView_heart);
    ...
    private void openRateDialog() {
        ...
        if (Constant.arrayList_play.get(viewpager.getCurrentItem()).getUserRating().equals("") || Constant.arrayList_play.get(viewpager.getCurrentItem()).getUserRating().equals("0")) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_SINGLE_SONG, 0, deviceId, Constant.arrayList_play.get(viewpager.getCurrentItem()).getId(), "", "", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "", null)).execute();
        } else {
            ...
            public void onClick(View view) {
                if(Constant.isLogged) {
                    if (ratingBar.getRating() != 0) {
                        if (methods.isNetworkAvailable()) {
                            Log.e("Atiar - ", "Clicked on rating button");
                    ...
                    Log.e("Atiar - ", "Clicked on rating button but not logged in");
                    //openGooglePlayForRating();
                    methods.clickLogin();
                }
            }
    ...
    public void openRateDialogForGooglePlay() {
        dialog_rate_for_google_play = new Dialog(BaseActivity.this);
        dialog_rate_for_google_play.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog_rate_for_google_play.setContentView(R.layout.layout_review_google_play);

        final ImageView iv_close = dialog_rate_for_google_play.findViewById(R.id.iv_rate_close);
        final TextView textView = dialog_rate_for_google_play.findViewById(R.id.tv_rate);
        final Button button = dialog_rate_for_google_play.findViewById(R.id.button_submit_rating);
        final Button button_later = dialog_rate_for_google_play.findViewById(R.id.button_later_rating);
        ...
        button_later.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialog_rate_for_google_play.dismiss();
            }
        });
        ...
        dialog_rate_for_google_play.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        dialog_rate_for_google_play.getWindow().getAttributes().windowAnimations = R.style.DialogAnimation;
        dialog_rate_for_google_play.show();
        Window window = dialog_rate_for_google_play.getWindow();
        window.setLayout(WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);
    }
