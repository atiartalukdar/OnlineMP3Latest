...
public class FragmentRecentSongs extends Fragment {
    ...
    private String addedFrom = "fav", recentSongIDs = "";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recentSongIDs = dbHelper.getRecentNewsIDs("200");
    ...
    private void loadRecentSongs() {
        if (methods.isNetworkAvailable()) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_SONG_BY_RECENT, page, "", recentSongIDs, "", "song", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "", null));
            loadSong.execute();
        } else {
