...
public class Constant implements Serializable {
    ...
    public static Boolean isRepeat = false, isSuffle = false, isPlayed = false, isFromNoti = false, isFromPush = false, isAppOpen = false, isOnline = true,
            isDownloaded = false, isBannerAd = true, isInterAd = true, isNativeAd = true, isSongDownload = false, isUpdate = false;
    ...
    public static String packageName, pushSID = "0", pushCID = "0", pushCName = "", pushArtID = "0", pushArtNAME = "", pushAlbID = "0", pushAlbNAME = "",
            search_item = "", bannerAdType = "admob", interstitialAdType = "admob", natveAdType = "admob";
